...
export default function SecurityAndSetting() {
  return (
   <div className=" ">
          <div className="flex items-center justify-between ">
            <div>
              <h2 className="text-2xl font-bold text-blue-900">Security and settings</h2>
          ...
          <div className="mt-[24px] flex flex-col gap-4">
            <div className='bg-[#F4F4F6] rounded-2xl border border-[#DFE0E4] py-[8px] px-4 flex justify-between items-center max-w-[260px] h-[50px]'>
                <div className="">
                    ...
                    <p className=' text-[12px] text-secondary/75'>johnsmith123@gmail.com</p>
                </div>
            ...
            <div className='bg-[#F4F4F6] rounded-2xl border border-[#DFE0E4] py-[8px] px-4 flex justify-between items-center max-w-[260px] h-[50px]'>
                <div className="">
                    ...
                    <p className=' text-[12px] text-secondary/75'>8708372955</p>
                </div>
                <ChevronRight className='ml-auto' />
            </div>
            <div className='bg-[#F4F4F6] rounded-2xl border border-[#DFE0E4] py-[8px] px-4 flex justify-between items-center max-w-[260px] h-[50px]'>
            ...
            <div className='bg-[#F4F4F6] rounded-2xl border border-[#DFE0E4] py-[8px] px-4 flex justify-between items-center max-w-[260px] h-[50px]'>
                <div className="">
                    <p className='text-sm font-semibold text-secondary'>Connected Devices</p>
                </div>
                <ChevronRight className='ml-auto' />
            </div>
          </div>
