      ...
      <div className="min-h-[calc(100vh-68px)] p-[40px] flex gap-[40px] justify-center  max-md:p-[20px]">
        ...
        <div className="min-w-[480px] max-w-[480px] max-sm:min-w-full flex flex-col gap-4">
            ...
            <div className="p-[40px] rounded-3xl border border-[#DFE0E4]  max-md:p-[16px]">
                <h5 className=' text-primary font-bold text-[24px]'>Log in</h5>
                <p className=' text-[14px] text-secondary'>Log in with your open account</p>
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <a href="" className=' font-medium text-[14px] text-fadeBlue text-right block'>forgot password?</a>
                    <button className='btn-pri w-full mt-[14px]'>Login</button>
                </div>
                <p className=' text-secondary/75 text-center mt-[18px]'>Don’t have an account, <a className=' font-semibold text-primary' href="">Sign up</a></p>
            </div>
        </div>
      </div>
    </div>
